...
export class AuthorService {
     ...
     * @return Success
     */
    getAll(au_search: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<AuthorDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<AuthorDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<AuthorDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<AuthorDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = AuthorDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<AuthorDtoPagedResultDto>(null as any);
    }
     ...
     * @return Success
     */
    createAuthor(body: CreateAuthorInput | undefined): Observable<AuthorDto> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateAuthor(response_ as any);
                } catch (e) {
    ...
    protected processCreateAuthor(response: HttpResponseBase): Observable<AuthorDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        return _observableOf<AuthorDto>(null as any);
    }
     ...
     * @return Success
     */
    updateAuthor(body: UpdateAuthorInput | undefined): Observable<AuthorDto> {
    ...
    protected processUpdateAuthor(response: HttpResponseBase): Observable<AuthorDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    changePosition(body: UpdatePositionAuthorInput | undefined): Observable<boolean> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processChangePosition(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processChangePosition(response_ as any);
                } catch (e) {
    ...
    protected processChangePosition(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class UserService {
     ...
     * @return Success
     */
    updateLoginState(userId: number | undefined): Observable<UserDto> {
        let url_ = this.baseUrl + "/api/services/app/User/UpdateLoginState?";
        if (userId === null)
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateLoginState(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateLoginState(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<UserDto>;
                }
            } else
    ...
    protected processUpdateLoginState(response: HttpResponseBase): Observable<UserDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class UserLoginAttemptsService {
     ...
     * @return Success
     */
    getUserLoginAttempt(userNameOrEmail: string | undefined): Observable<UserLoginAttemptsInforDto> {
        let url_ = this.baseUrl + "/api/services/app/UserLoginAttempts/GetUserLoginAttempt?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUserLoginAttempt(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUserLoginAttempt(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<UserLoginAttemptsInforDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<UserLoginAttemptsInforDto>;
        }));
    }

    protected processGetUserLoginAttempt(response: HttpResponseBase): Observable<UserLoginAttemptsInforDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = UserLoginAttemptsInforDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<UserLoginAttemptsInforDto>(null as any);
    }
}
...
export class UserLoginAttemptsInforDto implements IUserLoginAttemptsInforDto {
    userId!: number;
    userName!: string | undefined;
    logined!: boolean;
    browserInfo!: string | undefined;

    constructor(data?: IUserLoginAttemptsInforDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UserLoginAttemptsInforDto {
        data = typeof data === 'object' ? data : {};
        let result = new UserLoginAttemptsInforDto();
        result.init(data);
        return result;
    }
    ...
    clone(): UserLoginAttemptsInforDto {
        const json = this.toJSON();
        let result = new UserLoginAttemptsInforDto();
        result.init(json);
        return result;
...
export interface IUserLoginAttemptsInforDto {
    userId: number;
    userName: string | undefined;
    logined: boolean;
    browserInfo: string | undefined;
